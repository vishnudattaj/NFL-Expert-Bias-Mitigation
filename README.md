...
This project is the functional implementation of my research paper, "Beyond the Expert: An Algorithmic Approach to Correcting Expert Bias in Fantasy Football Projections," which is published in the [Wharton Sports Analytics Journal](https://wsb.wharton.upenn.edu/wharton-sports-analytics-journal/2026-spring-edition/#Jayanti).
